#!/usr/bin/env python3
""" Skeleton file for command line scripts
    Works in both python2 and python3, 3 is preferred.
"""
...
def main():
    ...
    if args.argument_name_in_parsed_args:
        # do something with argument value
        print("Your supplied argument for -a is: " + args.argument_name_in_parsed_args)
